...
# try "POST /$network/orderbook (simple)" "$API_URL/orderbook" '{"tag": "'"$eth-$wbtc"'"}'
# try "POST /$network/orderbook (simple)" "$API_URL/orderbook" '{"tag": "'"$eth-$dai"'"}'
# try "POST /$network/orderbook (simple)" "$API_URL/orderbook" '{"tag": "'"$eth-$usdt"'"}'
